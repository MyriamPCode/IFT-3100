...
void Interface::panelScene()
{
	...
	//int startY = 41 + lineHeight; // Position verticale de départ pour afficher les formes

	//vector<unique_ptr<Forme>>* ptrFormes = &renderer.getVecteurFormesPtr();
	//for (const auto& forme : *ptrFormes)
	//{
	//	int xPos = 41 + 10; // Position horizontale de départ pour afficher les informations de la forme
